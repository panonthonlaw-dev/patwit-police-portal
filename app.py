...
# --- [ส่วนที่ 1: ระบบเช็คสิทธิ์แก้ไข] ---
                ...
                # ==========================================
                # 🔍 [ส่วนที่เพิ่ม: ระบบออกหมายเรียกพร้อมตัวตรวจเช็ค]
                # ==========================================
                ...
                if user_role in ["admin", "super_admin"]:
                    ...
                    if case_status == "อยู่ระหว่างการดำเนินการ":
                        st.markdown("---")
                        st.info("⚖️ **ระบบออกหมายเรียกพร้อมใช้งาน**")
                        try:
                        ...
                        # 🚩 บรรทัดนี้จะช่วยบอกว่าทำไมปุ่มไม่ขึ้น (ลบออกได้ภายหลัง)
                        st.caption(f"ℹ️ ปุ่มหมายเรียกไม่แสดงเพราะสถานะปัจจุบันคือ: {case_status} (ต้องเป็น 'อยู่ระหว่างการดำเนินการ')")
                # ==========================================
