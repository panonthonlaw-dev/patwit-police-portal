...
# --- [ส่วนที่ 1: ระบบเช็คสิทธิ์แก้ไข] ---
                ...
                # ============================================================
                # ✅ [วางตรงนี้] ระบบออกหมายเรียก (ต้องอยู่ก่อน except ตัวสุดท้าย)
                # ============================================================
                if st.session_state.user_info.get('role') in ["admin", "super_admin"]:
                    # ตรวจสอบสถานะ: ต้องเป็น "อยู่ระหว่างการดำเนินการ"
                    if clean_val(row['Status']) == "อยู่ระหว่างการดำเนินการ":
                        st.markdown("---")
                        st.warning("⚖️ **ส่วนงานออกหมายเรียก:** ตรวจสอบชื่อผู้ถูกกล่าวหาให้ถูกต้องก่อนออกหมาย")
                        try:
                        ...
                        except Exception as summon_e:
                            st.error(f"❌ ไม่สามารถสร้างหมายเรียกได้: {summon_e}")
                # ============================================================
