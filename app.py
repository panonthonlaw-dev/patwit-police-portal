...
def monitor_center_module():
    ...
    try:
        ...
        if not df.empty and 'Status' in df.columns:
            ...
            with c3: render_monitor_column("✅ เสร็จสิ้น (10 ล่าสุด)", "#16a34a", df_done, "done", limit_scroll=999) # 999 คือเทคนิคบังคับไม่ให้เลื่อน
