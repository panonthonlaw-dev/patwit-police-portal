...
# ==========================================
# 4. MODULE: ANALYTICS (หัวข้อใหม่ - ดึงมาใช้เท่านั้น)
# ==========================================
def analytics_module():
    ...
    st.info("💡 ส่วนนี้จะใช้สำหรับดึงสถิติจากงานสอบสวนและงานจราจรมาสรุปภาพรวมพฤติกรรมนักเรียน")
...
def main():
    ...
    if not st.session_state.logged_in:
        ...
        if st.session_state.current_dept is None:
            ...
            st.markdown("---")
            # ปรับเป็น 3 คอลัมน์เพื่อเพิ่มปุ่มแผนกที่ 3
            c1, c2, c3 = st.columns(3)
            with c1:
                with st.container(border=True):
