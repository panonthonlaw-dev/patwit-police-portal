...
def traffic_module():
    ...
    if st.session_state.traffic_page == 'teacher':
        ...
        st.markdown("---") # เส้นคั่นก่อนส่วนจัดการขั้นสูง

        # ✅ โค้ดส่วนที่หายไป: ระบบจัดการเลื่อนชั้นเรียน (Super Admin Only)
        if st.session_state.current_user_pwd == UPGRADE_PASSWORD:
            with st.expander("⚙️ ระบบจัดการเลื่อนชั้นเรียน (Super Admin Only)"):
                ...
                # ช่องกรอกรหัส (ลบ value="Patwit1510" ออก เพื่อความปลอดภัย)
